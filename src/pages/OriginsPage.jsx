  ...
  return (
    <>
      <div className="page-hero">
        ...
        <div className="page-hero-title"><TypewriterText text="Origins" speed={18}/></div>
      ...
      <div className="main-wrap">
        ...
        <div className="content-section">
          <Reveal>
            ...
            <div className="sec-title"><TypewriterText text="In the Beginning, the Mountains. Then Kopecky." speed={20}/></div>
            <p className="prose">Before the Great Tatra mountains had their names, before the Váh river knew which direction to run — and it would later prove that even Kopecky was uncertain on this point, though he maintained otherwise — before the first Slovak looked at the landscape and thought <em>"this is ours, somehow,"</em> there was Kopecky. The Eternal One. The All-Knowing. The man who would eventually be wrong about a river in a way that five witnesses documented and three of those witnesses still bring up at gatherings.</p>
            <p className="prose">He descended from the high passes of the Vysoké Tatry on a Tuesday in early autumn, wearing a heavy woollen cloak whose colour has been described in the historical record as green, grey, brown, and "the colour of a decision that has not yet been made." He carried the satchel. He smelled of pine resin and considered opinion. The considered opinion was, as always, correct. The pine resin was simply pine resin.</p>
        ...
        <div className="content-section">
          <Reveal>
            ...
            <div className="sec-title"><TypewriterText text="The Arrival and the Wood Stack" speed={20}/></div>
        ...
        <div className="content-section">
          <Reveal>
            ...
            <div className="sec-title"><TypewriterText text="Before the Chud — The Time of Quiet Correctness" speed={20}/></div>
        ...
        <div className="content-section">
          <Reveal>
            ...
            <div className="sec-title"><TypewriterText text="The Events of the Walking" speed={20}/></div>
        ...
        <div className="content-section">
          <Reveal>
            ...
            <div className="sec-title"><TypewriterText text="What Was Left Behind" speed={20}/></div>
